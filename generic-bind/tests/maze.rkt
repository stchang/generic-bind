...
(define-syntax-rule (cons x y) (r:mcons x y))
(define set-car! r:set-mcar!)
(define set-cdr! r:set-mcdr!)
(define pair? r:mpair?)
...
;sys	0m0.024s
; runtime
; with ~define (4% slowdown)
;cpu time: 13252 real time: 13287 gc time: 404
;real	0m13.422s
;user	0m13.265s
;sys	0m0.116s
; with racket define
;cpu time: 12732 real time: 12768 gc time: 216
;real	0m13.041s
;user	0m12.925s
;sys	0m0.080s
